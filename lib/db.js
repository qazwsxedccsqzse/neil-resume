 ...
 */
var Work_Experience_Schema = new Schema({
	job_title : String,
	content : String,
	from : String,
	to : String
 ...
 */
var School_Experience_Schema = new Schema({
	schoolName : String,
	department : String,
	illustration : String
});
 ...
 */
 ...
 /**
  * 猜測應該是先建立這張collection,之後就可以直接透過mongoose.model('collection')使用
  */
 mongoose.model('WorkExperience',Work_Experience_Schema);
 mongoose.model('SchoolExperience',School_Experience_Schema);
